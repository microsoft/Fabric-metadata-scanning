...
## How To Autenticate
	...
	3. Click on Add -> Add Registration
	   ![img](https://github.com/yarinkagal/Fabric-Metadata-Scanning/blob/master/images/add_registretion.png)
	...
	8. Search for "Tenant" and check both Tenant.Read.All and Tenant.ReadWrite.All permissions.
	   ![img](https://github.com/yarinkagal/Fabric-Metadata-Scanning/blob/master/images/add_permission.png)
	...
	10. On the left bar, go to Overview, and copy the Application (client) ID and Directory (tenant) ID to the configuration file (under "auth").
			   ![img](https://github.com/yarinkagal/Fabric-Metadata-Scanning/blob/master/images/clientId.png)
